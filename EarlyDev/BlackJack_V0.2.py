...
def game(bank, winnings, turns):
    ...
    print("\nWelcome To Conors's Blackjack! Version 2.0")
...
def playerWin(bank, winnings, bet):
    bank += bet
    winnings += bet
    print("\nYour Bank: {}".format(bank))
    print("Your Winnings: {}".format(winnings))
...
def playerBJ_win(bank, winnings, bet):
    bank += bet + bet/2
    winnings += bet + bet/2
    print("\nYour Bank: {}".format(bank))
    print("Your Winnings: {}".format(winnings))
    return bank, winnings, bet

def playerLose(bank, winnings, bet):
    bank -= bet
    winnings -= bet
    print("\nYour Bank: {}".format(bank))
    print("Your Winnings: {}".format(winnings))
