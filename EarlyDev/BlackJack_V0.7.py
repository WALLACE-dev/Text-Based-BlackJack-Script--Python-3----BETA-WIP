...
def suits():
    suits = [ "Clubs", "Diamonds", "Hearts", "Spades", "Clubs", "Diamonds", "Hearts", "Spades","Clubs", "Diamonds", "Hearts", "Spades"]
    return suits
                ...
                if dealerHand < 21 and dealerHand <= playerHand:
                    ...
                    if dealerHand < 21 or dealerHand <= playerHand:
                        ...
                        if dealerHand > playerHand and dealerHand < 21:
                            ...
                            bank, winnings = playerWin(dealerHand, playerHand, bank, winnings, bet)
                            time.sleep(1)
                            playAgain(bank, winnings, count)
                    ...
                    bank, winnings = dealerBlackJack(dealerHand, playerHand, bank, winnings, bet)
                    time.sleep(1)
                    playAgain(bank, winnings, count)
            elif dealerHand > playerHand and dealerHand < 21:
                bank, winnings, count = dealerWin(dealerHand, playerHand, bank, winnings, bet, count)
...
def game(bank, winnings, count):
    ...
    print("\nWelcome To Conors's Blackjack! Version 7.0")
    displayCount(count)
    time.sleep(2)
...
def playerSafe(dealerHand, playerHand, bank, winnings, bet):
            decision(playerHand, dealerHand, bank, winnings, bet, count)
...
def optionOne(playerHand, dealerHand, bank, winnings, bet, count):
        ...
        if playerHand > 21:
            ...
            bank, winnings = playerSafe(dealerHand, playerHand, bank, winnings, bet)
            playAgain(bank, winnings, count)
        elif playerHand == 21:
            bank, winnings = playerBlackjack(dealerHand, playerHand, bank, winnings, bet)
            playAgain(bank, winnings, count)
...
def playerWin(dealerHand, playerHand, bank, winnings, bet):
    print("\nDealer: {}".format(dealerHand))
    time.sleep(1.5)
    print("Player: {}".format(playerHand))
    time.sleep(1.5)
...
def dealerBlackJack(dealerHand, playerHand, bank, winnings, bet):
    time.sleep(1.5)
    print("\nDealer: {}".format(dealerHand))
    print("Player: {}".format(playerHand))
    time.sleep(1.5)
...
def playerBlackjack(dealerHand, playerHand, bank, winnings, bet):
        print("\nDealer: {}".format(dealerHand))
        time.sleep(1.5)
        print("Player: {}".format(playerHand))
        time.sleep(1.5)
